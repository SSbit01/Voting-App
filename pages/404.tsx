...
export default function Error404Page() {
  return (
    <main className="flex flex-col items-center justify-center gap-9 text-center p-5 mt-10">
      ...
      <Link href="/" className="flex justify-center gap-3 transition bg-cyan-800 text-slate-100 text-xl font-medium p-3 rounded-lg shadow-lg cursor-pointer hover:bg-cyan-700 focus:ring-4">
